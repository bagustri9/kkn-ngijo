...
class SuratKeteranganTidakMampuController extends Controller
{
    ...
    {
        $data = SuratKeteranganTidakMampu::get();
    ...
    {
        return SuratKeteranganTidakMampu::count() > 0 ? SuratKeteranganTidakMampu::max('no_surat') : 0;
    }

    public function store(Request $request)
    {
        $nosurat = $this->getNosurat();
        $data = SuratKeteranganTidakMampu::create(array_merge($request->all(), ['no_surat' => ++$nosurat]));
        return response()->json($data);
    }
    ...
    {
        $data = SuratKeteranganTidakMampu::where('no_surat', $id)->first();
        return response()->json($data);
    }
